...
def do_inference(maker: DyadicFrameMaker, items: List[Tuple[str, str]], max_tokens: int = 512) -> List[DyadicFrameWrapper]:
    outputs = []
...
if __name__ == '__main__':
    ...
    save_to_file(outpath_jsonl=f'''results/{model_dir_name}/dyadic{'_all_circumstances' if args.all_circumstances else ''}.tsv''', inputs=items, outputs=cfs)
